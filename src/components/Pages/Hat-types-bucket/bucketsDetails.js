...
function BucketsDetails(props) {
    ...
    const thisBeret = bucketsData.find(bucket => bucket._id === bucketsId)
                        ...
                        <ImageGallery {... (
                            {
                                ...
                                items: [
                                    {
                                        original: `../images/buckets/bu${bucketsId}.jpg`,
                                        thumbnail: `../images/buckets/bu${bucketsId}.jpg`,
                                    },
                                    {
                                        original: `../images/buckets/bu${bucketsId}a.jpg`,
                                        thumbnail: `../images/buckets/bu${bucketsId}a.jpg`,
                                    },
                                ]
